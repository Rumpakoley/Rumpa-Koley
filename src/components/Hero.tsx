...
export const Hero: React.FC<HeroProps> = ({ onOpenResumeModal }) => {
  ...
  return (
    <section
      ...
      className="min-h-screen relative flex flex-col justify-between pt-28 md:pt-36 pb-12 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto overflow-hidden"
    >
      ...
      <div className="mt-8 pt-6 border-t border-white/[0.08] flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
